      ...
      >
        <div className="relative">
          <img
            src={Jason2}
            alt="pizza Image"
            className="md:w-[430px] md:h-[560px] sm-w[300px] sm:h[400px] h-[350px] w-[290px] object-cover"
          />
          ...
          <div className="absolute md:w-[430px] md:h-[560px] sm-w[300px] sm:h[400px] h-[350px] w-[290px] border-[5px] border-gray-900 top-[20px] left-6 z-[-20]"></div>
        </div>
      </motion.div>
    </div>
  );
